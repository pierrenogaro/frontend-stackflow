...
const fetchQuestion = async () => {
  ...
  error.value = null;
  try {
    const response = await axios.get(`https://stackflow.pierrenogaro.com/questions/${route.params.id}/?t=${new Date().getTime()}`);
...
const submitAnswer = async () => {
  ...
  try {
    await axios.post(
        `https://stackflow.pierrenogaro.com/questions/${route.params.id}/answers/`,
...
const submitComment = async () => {
  ...
  try {
    await axios.post(
        `https://stackflow.pierrenogaro.com/questions/${route.params.id}/comments/`,
...
const deleteAnswer = async (id) => {
  ...
  try {
    await axios.delete(`https://stackflow.pierrenogaro.com/answer/delete/${id}/`, {
      headers: { Authorization: `Bearer ${token}` }
    });
    await fetchQuestion();
  } catch (err) {
...
const deleteComment = async (id) => {
  ...
  try {
    await axios.delete(`https://stackflow.pierrenogaro.com/comments/delete/${id}/`, {
      headers: { Authorization: `Bearer ${token}` }
    });
    await fetchQuestion();
  } catch (err) {
